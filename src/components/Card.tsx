    ...
    <>
      <section className="card_section top-[90vh]  absolute left-0 w-full remove_scrollbar min-h-[100vh] flex items-center justify-center overflow-x-hidden">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-3  py-6 px-2 h-full remove_scrollbar overflow-visible pt-20 items-center max-w-5xl">
            ...
            <div className="card_border rounded-xl max-h-[35rem] h-[80vh] lg:max-w-[20rem] flex justify-center">
              ...
              <div className="card_component px-2.5 py-3.5 rounded-xl overflow-x-hidden bg-white text-xs max-h-[35rem] h-[80vh] shadow-xl ">
                ...
                <div className="mt-10 px-3 ">
                  <div className="flex flex-col card_section">
                    <span className="text-4xl font-bold">$1627.97</span>
                    <span className="text-red-500 mt-1">$35.67 (-1.37%)</span>
                  </div>
                  <div className="flex card_section items-center justify-between gap-4 mt-10 text-xs font-bold">
                  ...
                  <div className="card_section flex items-center justify-center  mt-5 w-full font-bold text-center">
                    <div className="w-full ">Tokens</div>
                    <div className="w-full ">NFTS</div>
                    <div className="w-full ">Activity</div>
                  </div>

                  <div className="card_section border-b-0.5 mt-2 outline" />
                  <div className="flex flex-col gap-3 mt-5">
                    <div className="flex card_section items-center justify-between my-6">
          ...
          <div className="slide_contents outline max-h-[35rem] h-[80vh]">
            <TradeNFTCard />
          </div>
        </div>
      </section>
