...
const Header = () => {
  ...
  return (
    <>
      <div ref={containerRef} className='header_container h-screen absolute w-full' />

      <section
        ref={firstRef}
        className='header_section fixed top-0 left-0 p-5 w-full text-sm z-[999999999]'
      >
        <div className='header_first w-full px-3.5 py-2.5 flex items-center justify-between bg-white rounded-xl text_black font-bold'>
