...
import { NFTCardHoverAnimation } from "@/animations/NFTCardHoverAnimation";


const TradeNFTCard = () => {

    useGSAP(() => {
        // NFTCardHoverAnimation()
    }, [])

  return (
    <>
      {/* <div className="bg-[#E5FFC3] w-full h-full rounded-xl p-5 green_card">
        <div className=" text-white leading-8.5">
          Buy, Sell, Swap,
          <br /> Send, Receive
        </div>
        ...
        <div className=" text-2xl absolute top-55 font-bold opacity-0 text-white leading-8.5">
